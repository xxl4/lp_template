...
!(function (e) {
  function t(t, i) {
    e(".sticky-element-original")
      .clone()
      .insertAfter(e(".sticky-element-original"))
    ...
    return (
      ...
      l < 1
        ...
        ? (e(this)
          ...
          1 != s.dynamicmode && t(s.top, s.zindex, s.adminbar),
          (checkElement = setInterval(function () {
            !(function (i, n, s, l, o, r, d) {
              ...
              (viewport = m[g + "Width"]),
                d && e("body").hasClass("admin-bar") && viewport > 600
                  ? (adminBarHeight = e("#wpadminbar").height())
                  : (adminBarHeight = 0);
              e(window).scrollTop() >= orgElementTop - i - adminBarHeight &&
              viewport >= n &&
              viewport <= s
                ? ((orgElement = e(".sticky-element-original")),
                  (coordsOrgElement = orgElement.offset()),
                  (leftOrgElement = coordsOrgElement.left),
                  (widthOrgElement =
                    orgElement[0].getBoundingClientRect().width),
                  widthOrgElement ||
                  ...
                  (paddingCloned =
                    ...
                    " " +
                    paddingOrgElement[3]),
                  1 == r && e(".sticky-element-cloned").length < 1 && t(i, l),
                  (elementHeight = 0),
                  heightOrgElement < 1
                    ? (elementHeight = e(
                  ...
                  o &&
                  e(window).scrollTop() >
                    pushElementTop - i - elementHeight - adminBarHeight
                    ? (stickyTopMargin =
                        pushElementTop -
                        i -
                        elementHeight -
                  ...
                  e(".sticky-element-cloned")
                    ...
                    .show(),
                  e(".sticky-element-original").css("visibility", "hidden"))
                : (1 == r
                    ? e(".sticky-element-cloned").remove()
                    : e(".sticky-element-cloned").hide(),
                  e(".sticky-element-original").css("visibility", "visible"));
            })(
              s.top,
              s.minscreenwidth,
              s.maxscreenwidth,
        ...
        : (e(this)
          ...
          (orgAssignedStyles =
            ((n = e(this)),
            (o = {}),
            (o.display = n.css("display")),
            (o.float = n.css("float")),
            (o.flex = n.css("flex")),
            (o["box-sizing"] = n.css("box-sizing")),
            (o.clear = n.css("clear")),
            (o.overflow = n.css("overflow")),
            (o.transform = n.css("transform")),
            o)),
          (orgInlineStyles = e(".sticky-element-original").attr("style")),
          null == orgInlineStyles && (orgInlineStyles = ""),
          e(".sticky-element-original")
          ...
          (checkElement = setInterval(function () {
            !(function (t, i, n, s, l, o, r, d) {
              ...
              "innerWidth" in window ||
                ...
                (m = document.documentElement || document.body));
              (viewport = m[g + "Width"]),
                o && e("body").hasClass("admin-bar") && viewport > 600
                  ? (adminBarHeight = e("#wpadminbar").height())
                  : (adminBarHeight = 0);
              if (
                e(window).scrollTop() >= orgElementTop - t - adminBarHeight &&
                viewport >= i &&
                viewport <= n
              ) {
                for (var h in ((coordsOrgElement = $listenerElement.offset()),
                (leftOrgElement = coordsOrgElement.left),
                (widthPlaceholder =
                  $listenerElement[0].getBoundingClientRect().width),
                widthPlaceholder ||
                  (widthPlaceholder = $listenerElement.css("width")),
                (heightPlaceholder =
                  $listenerElement[0].getBoundingClientRect().height),
                heightPlaceholder ||
                  (heightPlaceholder = $listenerElement.css("height")),
                (widthSticky = e(".sticky-element-original").css("width")),
                "0px" == widthSticky &&
                  (widthSticky = e(
                    ".sticky-element-original"
                  )[0].getBoundingClientRect().width),
                (heightSticky = e(".sticky-element-original").height()),
                (paddingOrgElement = [
                  e(".sticky-element-original").css("padding-top"),
                  e(".sticky-element-original").css("padding-right"),
                  e(".sticky-element-original").css("padding-bottom"),
                  e(".sticky-element-original").css("padding-left"),
                ]),
                (paddingSticky =
                  paddingOrgElement[0] +
                  " " +
                ...
                r))
                  "inline" == r[h]
                    ? (assignedStyles += h + ":inline-block; ")
                    : (assignedStyles += h + ":" + r[h] + "; ");
                (elementHeight = 0),
                  heightPlaceholder < 1
                    ? (elementHeight = e(
                        ".sticky-element-cloned"
                  ...
                  l &&
                  e(window).scrollTop() >
                    pushElementTop - t - elementHeight - adminBarHeight
                    ? (stickyTopMargin =
                        pushElementTop -
                        t -
                        elementHeight -
                  ...
                  e(".sticky-element-original")
                    ...
                    .css("z-index", s),
                  e(".sticky-element-original").each(function () {
                  ...
                  e(".sticky-element-placeholder").hasClass(
                    "sticky-element-active"
                  ) ||
                    e(".sticky-element-placeholder")
                      .addClass("sticky-element-active")

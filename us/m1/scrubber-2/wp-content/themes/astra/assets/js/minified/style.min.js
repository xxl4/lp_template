  ...
  function e() {
    ...
    if (0 < s.length)
      for (var n = 0; n < s.length; n++)
        "DIV" == s[n].tagName &&
          s[n].classList.contains("main-header-bar-wrap") &&
          (a < t
            ? (null != r[n] && r[n].classList.remove("toggled"),
    ...
    var t,
      ...
      l =
        ...
        (AstraToggleSubMenu = function () {
          ...
          for (
            ...
            if (o[s] != t) {
              ...
              for (
                var r = o[s].querySelectorAll(".sub-menu"), l = 0;
                l < r.length;
                l++
              )
            ...
            for (var t, a = 0; a < r.length; a++)
              if (
                ...
                for (var s = 0; s < t.length; s++)
                  t[s].addEventListener("click", AstraToggleSubMenu, !1);
        }),
        (astraNavMenuToggle = function (e) {
          ...
          for (
            var a = e[t].querySelectorAll(".menu-item-has-children"), s = 0;
            s < a.length;
            s++
          ) {
            a[s].classList.remove("ast-submenu-expanded");
            for (
              var n = a[s].querySelectorAll(".sub-menu"), o = 0;
              o < n.length;
              o++
            )
            ...
            if (0 < e.length)
              for (var t = 0; t < e.length; t++) {
                null != e[t] &&
                  ...
                  (e[t].style.display = ""));
                for (
                  var a = e[t].getElementsByClassName("sub-menu"), s = 0;
                  s < a.length;
                  s++
                )
                  a[s].style.display = "";
                for (
                  var n = e[t].getElementsByClassName("children"), o = 0;
                  o < n.length;
                  o++
                )
                  n[o].style.display = "";
                ...
                if (e) {
                  ...
                  if (
                    ...
                    if (void 0 === a) t.style.display = "none";
                      ...
                      for (
                        var s = a.getElementsByTagName("a"),
                          n = a.getElementsByTagName("ul"),
                          o = 0,
                          r = n.length;
                        o < r;
                        o++
                      )
                        n[o].parentNode.setAttribute("aria-haspopup", "true");
                      for (o = 0, r = s.length; o < r; o++)
                        s[o].addEventListener("focus", d, !0),
                          s[o].addEventListener("blur", u, !0),
                          s[o].addEventListener("click", c, !0);
                    }
                  }
                }
              })(e[t]);
        ...
        /trident/i.test(s[1])
          ? (t = /\brv[ :]+(\d+)/g.exec(a) || [])
          : ("Chrome" === s[1] && null != (t = a.match(/\bOPR|Edge\/(\d+)/))) ||
            ((s = s[2]
              ? [s[1], s[2]]
              : [navigator.appName, navigator.appVersion, "-?"]),
            null != (t = a.match(/version\/(\d+)/i)) && s.splice(1, 1, t[1]),
            (a = document.body),
            "Safari" === s[0] &&
              s[1] < 11 &&
              a.classList.add("ast-safari-browser-less-than-11")),
    ...
    if (
      ...
      if (
        ...
        var t = document.querySelector(".menu-below-header-toggle"),
          ...
          s = document.querySelector(".ast-below-header-actual-nav"),
          t =
            (t &&
              a &&
              s &&
          ...
          s = document.querySelector(".ast-above-header-navigation");
        t &&
          a &&
          s &&
          (t.classList.remove("toggled"),
